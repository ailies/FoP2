...
public class AbstractPage extends PageObject {
	...
	/**
	 * This method verifies that an alert message is present and if so, it
	 * accepts the alert condition
	 */
	...
	/**
	 * Selects the desired option from the provided drop-down that contains the
	 * searched terms with the possibility of choosing whether or not to ignore
	 * the case.
	 * 
